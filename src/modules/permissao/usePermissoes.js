      ...
      mutationFn:
        async ({
          ...
          if (
            ...
            throw new Error(
              "Sem permissão para editar roles"
            )
          }
          ...
          if (
            ...
            throw new Error(
              "Sem permissão para criar roles"
            )
          }
      ...
      mutationFn:
        async (id) => {
          ...
          if (
            ...
            throw new Error(
              "Sem permissão para excluir roles"
            )
          }
